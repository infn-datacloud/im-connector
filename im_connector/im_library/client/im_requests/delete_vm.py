...
from im_connector.im_library.entities.im_base_requests import Delete
from im_connector.im_library.entities.im_request_parameters import IMPathParametersBase


@dataclasses.dataclass(kw_only=True)
class DeleteVMPathParameters(IMPathParametersBase):
    InfId: str
    VMId: str
...
class DeleteVM(Delete):
    def __init__(self, *,
                 path_parameters: DeleteVMPathParameters,
                 body: str):
